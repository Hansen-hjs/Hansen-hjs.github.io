...
var myInfo = {
    ...
    comment: '自我评价：做过的项目类型有web、web-App、hybrid-App、公众号、小程序和小游戏，对于开发有丰富的领域经验能快速高效的进行项目部署。对移动端前端开发有深入了解，并且自己写过了一些移动端的日常插件（ES6）：swiper轮播图、手势放大缩小图片、用户交互提示、下拉刷新、图片懒加载、基于fech.js的Ajax、小球抛物线，按钮点击水波纹。线上预览地址：skt.webgz.cn/vue-dome代码在github上。无论对开发环境Webpack+node.js+Vue.js还是直接原生JavaScript开发都能够熟练掌握使用，并且在性能至上的前提下进行开发。',
    projectList: [
        {
            index: 1,
            title: '电力系统-webAPP',
