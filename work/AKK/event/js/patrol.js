...
function danger(json,taskType,taskDetails){
	 for (var i = 0; i < json.troublePatrolTaskList.length; i++){
    	if(taskType==1){							// 已完成
    		$("#patrol_content h2").text("已完成");
    		$("#patrol_content h2").css({backgroundImage: "url(../img/icon_confirm.png)"});
        	...
        	$("#patrol_content h2").text("巡检中");
    		$("#patrol_content h2").css({backgroundImage: "url(../img/icon_patrol.png)"});
        	...
        	$("#patrol_content h2").text("未完成");
    		$("#patrol_content h2").css({backgroundImage: "url(../img/icon_uncomplete.png)"});
    ...
    if(json.troublePatrolTaskList.length>0){
    	$("#patrol_content h3").hide();
    }else{
    	$("#patrol_content h3").show();
    }
