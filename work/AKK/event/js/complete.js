...
function danger(json,taskType,taskDetails){
	 for (var i = 0; i < json.troublePatrolTaskList.length; i++){
    	if(taskType==1){							// 已完成
    		$("#complete_content h2").text("已完成");
    		$("#complete_content h2").css({backgroundImage: "url(../img/icon_confirm.png)"});
        	...
        	$("#complete_content h2").text("巡检中");
    		$("#complete_content h2").css({backgroundImage: "url(../img/icon_patrol.png)"});
        	...
        	$("#complete_content h2").text("未完成");
    		$("#complete_content h2").css({backgroundImage: "url(../img/icon_uncomplete.png)"});
    ...
    if(json.troublePatrolTaskList.length>0){
    	$("#complete_content h3").hide();
    }else{
    	$("#complete_content h3").show();
    }
